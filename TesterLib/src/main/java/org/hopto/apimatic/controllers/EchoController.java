        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 4855183111610112910L;
                    {
    ...
    public void jsonEchoAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //load all headers for the outgoing API request
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 4961465656600501075L;
                    {
                        put( "user-agent", "Stamplay SDK" );
                        put( "accept", "application/json" );
    ...
    public void formEchoAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //load all headers for the outgoing API request
                Map<String, String> _headers = new HashMap<String, String>() {
                    private static final long serialVersionUID = 4743484437114952741L;
                    {
                        put( "user-agent", "Stamplay SDK" );
                        put( "accept", "application/json" );
                    }
                ...
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = 5251343270346880724L;
                    {
                        put( "input", input );
                    }
                };
